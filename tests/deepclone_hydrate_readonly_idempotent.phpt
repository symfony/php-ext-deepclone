...
$o = deepclone_hydrate($o, ['v' => 42]);
var_dump($o->v === 42);

// Different value → engine throws
$o = new ReadonlyInt(42);
try {
    deepclone_hydrate($o, ['v' => 43]);
    var_dump(false);
} catch (\Error $e) {
...
$o = deepclone_hydrate(ReadonlyInt::class, ['v' => 99]);
var_dump($o->v === 99);
